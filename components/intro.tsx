...
import profileImg from "@/public/profile_port.jpeg";
...
export default function Intro() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        <span className="font-bold">Hello I'm Noppadol.</span> I'm a{" "}
      ...
      >
        ...
        <a
          ...
          target="_blank"
        >
          <BsLinkedin className="opacity-60 group-hover:transition" />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10"
